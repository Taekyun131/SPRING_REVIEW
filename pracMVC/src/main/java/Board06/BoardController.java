...
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(action!=null && action.equals("/replyForm.do")) {
			return;
		}
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(action==null || action.equals("/listArticles.do")) {
				...
				System.out.println(articleNO);
				List<Integer> articleNOList=boardService.removeArticle(articleNO);	// articleNO 값에 대한 글을 삭제한 후 삭제된 부모글과 자식글의 articleNO 목록을 가져옴
				...
				System.out.println(session.getAttribute("parentNO"));
